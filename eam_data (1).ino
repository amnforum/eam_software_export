...
const char* ssid = "mnsa"; //--> Your wifi name or SSID.
const char* password = "12344321"; //--> Your wifi password.
//----------------------------------------
...
String GAS_ID = "AKfycbz8ylhclMucL6AUKyRQSY18K3Z1Oe-4_HotWoMyhnUfn7eTvE8u57YYrwpFG7DzbnE"; //--> spreadsheet script ID
